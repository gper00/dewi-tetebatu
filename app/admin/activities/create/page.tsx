...
export default function CreateActivityPage() {
  ...
  // Arrays for dynamic lists if needed, e.g. includes/excludes, keeping simple for now?
  // Schema has: includes, highlights. Let's add basic support for highlights.
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-bold text-slate-800">Tambah Kegiatan / Event</h1>
      </div>
